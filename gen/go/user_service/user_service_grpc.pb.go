...
func (c *userServiceClient) GetUserInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (UnimplementedUserServiceServer) GetUserInfo(context.Context, *emptypb.Empty) (*UserInfo, error) {
